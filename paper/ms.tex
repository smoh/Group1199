...
{\bf \noindent
  ...
  may eventually lead to a difference in compositions of the component stars' radiative and
...
the abundances of \bizarreone\ show selective under-enhancement in
\elem{C}, \elem{N}, \elem{O}, \elem{Na}, and \elem{Mn}
relative to \elem{Fe} and other refractory elements.
%
...
gas\citet{2003ApJ...591.1220L} in Figure~\ref{fig:toycalc}.
...
scattering\cite{} or encounters\cite{Malmberg:2011aa} with a field star can
lead some planets to be ejected or accreted onto its host star.
If one of the two stars in a wide binary accreted refractory-rich (rocky) planets
more than the other, the accretion may imprint a strong \Tcondens\-dependent
...
We estimate that accretion of $\approx 20$~\mearth\ of rocky planets
