...
\begin{abstract}
  ...
  yet both stars show very high surface \elem{Li} abundance for this age.
  ...
  %around these stars will help illuminate planet-star interactions.
\end{abstract}
...
\todo{might as well note no orbits ever established at these separations}
...
\todo{add microturb vel to tab 1}
...
the systematic uncertainties for these two solar-type ``twin-like'' stars in
terms of $T_\mathrm{eff}$ and $\log{g}$, if any, are unlikely to wash out
the observed abundance differences.
