...
% - USe "phase space" not "phase-space".
...
%TODO: what is assumed for uncertanties in RV?
...
%TODO: APW what is the histogram of?
%TODO: plot styles...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=\linewidth]{orbits.pdf}
  \end{center}
  \caption{Galactic orbits computed for \sunanalog\ (black) and the Sun (grey).
    For \sunanalog, the initial conditions are set to the median of the
    posterior sample over the phase space coordinates.
...
%TODO: APW to check (missing) citations
...
\end{eqnarray}
\eqname~\ref{eq:crosssection} is appropriate when $v \gg 1$ (\citealt{Hut:1983aa,Hut:1983ab}),
which is the case for wide binaries scattering with field (disk) stars.
