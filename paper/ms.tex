...
% ------------------------
{\bf \noindent
  Stars that are born together are expected to have same space motion and chemical compositions initially.
  Detailed chemical abundance studies of stars in wide binaries indeed reveal nearly identical
  chemistry in most cases.
  However, formation and evolution of different planetary systems around each star in a wide binary
  may eventually lead to a difference in the compositions of the stars' radiative and convective layers.
  A handful of wide binaries that show small differences in their surface chemical abundance have been reported so far.
  However, no pair .
  Here we report a comoving pair of bright G stars, HD~240430 and HD~240429,
  ...
  of the stars within the last gigayear.
...
High resolution spectra of both stars were obtained using the HIRES spectrograph
on the Keck-I telescope in a separate effort to
to study detailed chemical abundances of potential
planet-hosting stars \cite{2016ApJS..225...32B}.
