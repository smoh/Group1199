...
\begin{figure}[htpb]
  ...
  \caption{Abundances of the comoving pair, \sunanalog\ and \bizarreone\
    ...
    \bizarreone\ is enhanced in \elem{Fe} by $\approx 0.2$~dex relative to \sunanalog\
    along with \elem{Mg}, \elem{Al}, \elem{Si}, \elem{Ca}, \elem{Ti}, \elem{V},
    \elem{Cr}, \elem{Ni}, \elem{Y} yet not in \elem{C}, \elem{N}, \elem{O}, \elem{Na}, and \elem{Mn}.
  }
...
\begin{figure}[htpb]
  ...
  \caption{Difference in abundances of this pair and other wide binaries in
    ...
    First, we see that most of the other comoving wide binaries included in \citealt{2016ApJS..225...32B}
    have small ($<0.1$~dex) differences in all elements making a difference of $\approx 0.2$~dex seen in
    \bizarreone-\sunanalog\ pair rare.
    Second, random pairings of disk stars with similar $\Delta\feh$ usually show
    similar enhancement in all other elements.
    %Notably, the relative depletion of \elem{Na} and \elem{Mn} with respect to \elem{Fe}
    %suggests that even when we assume \bizarreone\ and \sunanalog\ are of different origin,
    %Galactic evolution cannot explain the difference.
  }
  \label{fig:deltaXH}
\end{figure}
...
We stress that none of the other four twin-like ($\Delta T_mathrm{eff} \lesssim 100$~K)
wide binary pairs examined in \citealt{2016ApJS..225...32B} show discrepancies in abundances between the
stars at this level (\figname~\ref{fig:deltaXH}).
...
\figname~\ref{fig:deltaXH} shows the distribution of $\Delta[\elem{X}/\elem{H}]$
for random pairings of two stars from similar \feh\ as \bizarreone\ and \sunanalog
...
% Clean up:
% Specifically, it is very unlikely that the star 
% The abundance of \bizarreone\ is peculiar on its own compared to other disk
stars with similar \feh.
%For a star with $\feh \approx 0.2$ like \bizarreone, we generally expect
%$[\elem{Na}/\elem{Fe}] > 0$ and $[\elem{Mn}/\elem{Fe}] > -0.1$
%(\citealt{Battistini:2015aa,Bensby:2003aa}) making the abundances of \bizarreone\
%very unlikely to arise from Galactic chemical evolution.
